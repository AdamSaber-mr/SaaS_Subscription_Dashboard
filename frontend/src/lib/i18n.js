...
const DICT = {
  nl: {
    ...
    nav: { dashboard: 'Dashboard', insights: 'Inzichten', customers: 'Klanten', plans: 'Plannen', subscriptions: 'Abonnementen' },
  ...
  en: {
    ...
    nav: { dashboard: 'Dashboard', insights: 'Insights', customers: 'Customers', plans: 'Plans', subscriptions: 'Subscriptions' },
